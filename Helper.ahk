...
Gui 3: Add, Text,,                =================================================================================================================================================================================================================================================================================================================================================================================
WinSet, TransColor, %CustomColor2% 500
...
Xbutton1::
SendMessage, 0x50,, 0x4190419,, A
SendInput, Здравствуйте, иду.{Enter}
Return
...
:?:.рек::Попробуйте перезайти через F1 > Direct Connect > Connect или полностью в игру (F1 - Quit Game).{Enter}
:?:.рп::Извините, но это РП процесс, мы не вправе вмешиваться в него.{Enter}
:?:.урп::Приветствую, данную информацию вы можете получить при взаимодействии с другими игроками/самостоятельным поиском непосредственно во время игрового процесса, либо другим доступным IC путем. Приятной игры и самого лучшего настроения на Majestic RP.{Enter}
:?:.войс::Чтобы перезагрузить войс, попробуйте нажать F7 или /v_reload в чат. Если ничего не помогает - перезайдите в игру.
:?:.тех::Здравствуйте, напишите в технический раздел на форуме.{Enter}
...
:?:.пузо::Нужная поза о которой Вам говорят находится F2 - Анимации - Позы - Лежать на животе. Не игнорируйте данное сообщение чтобы не получить наказание.
...
:?:.подним::Приветствую. К сожалению, не видя всей ситуации мы не в праве лечить,поднимать или добивать игроков. Дождитесь сотрудников EMS либо же окончания таймера смерти. Приносим свои извинения за возможные неудобства.{Enter}
...
:?:.тер::Приветствую. Это одобренный терракт.
:?:.адс::Данный администратор сейчас отсутствует или занят, напишите ему в личные сообщения в дискорде.{Enter}
:?:.погода::К сожалению, администрация не контролирует данный процесс. Погода меняется автоматически.
:?:.неп::Опишите Вашу проблему/вопрос подробнее в /report для максимально точного ответа, пожалуйста.{Enter}
...
:?:.реп::Приветствую. Пожалуйста, уточните свой вопрос подробнее в /report. Администрация не летает на репорты по типу 'админ тп', 'админ можно поговорить', 'помогите', 'админ есть вопрос'. Количество символов в /report неограничено, вы можете полностью расписать Вашу проблему/вопрос. {Enter}
